...
function ComboboxItem({
  ...
  return (
    <ComboboxPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-default items-center gap-2 rounded-sm border border-transparent py-1.5 pr-8 pl-2 text-sm outline-hidden select-none data-highlighted:border-neutral-400 data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
...
function ComboboxLabel({
  ...
  return (
    <ComboboxPrimitive.GroupLabel
      ...
      className={cn(
        "px-2 py-1.5 text-preset-5 text-xs text-muted-foreground uppercase",
        className
      )}
      {...props}
    />
